 ...
 *   https://datatables.net/download/#bs4/dt-1.10.16/af-2.2.2/b-1.5.1/b-colvis-1.5.1/b-html5-1.5.1/b-print-1.5.1/sl-1.2.5
 *
 * Included libraries:
 *   DataTables 1.10.16, AutoFill 2.2.2, Buttons 1.5.1, Column visibility 1.5.1, HTML5 export 1.5.1, Print view 1.5.1, Select 1.2.5
 */
...
(function( $, window, document, undefined ) {
	...
	function _fnLanguageCompat( lang )
	{
		...
		if ( ! lang.sEmptyTable && zeroRecords &&
			defaults.sEmptyTable === "Não existem dados para exibir" )
		{
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *  @type string
			 *  @default Não existe dados para exibir
			 *
			 *  @dtopt Language
			 ...
			 *    } );
			 */
			"sEmptyTable": "Não existem dados para exibir",
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs4/dt-1.10.16/af-2.2.2/b-1.5.1/b-colvis-1.5.1/b-html5-1.5.1/b-print-1.5.1/sl-1.2.5",
...
$.extend( true, DataTable.defaults, {
	dom:
		"<'row'<'col-md-6 mt-3'f><'col-md-6 mt-3'p>>",
