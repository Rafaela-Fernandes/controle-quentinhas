<div class="form-row">
    ...
    <div class="col-md-4  input-group mb-4">
        ...
        <select class="form-control" name="prato-ter-01">
                                <option value=""></option>
                                <?php 
    ...
    <div class="col-md-4  input-group mb-4">
        ...
        <select class="form-control" name="carne-ter-01">
                                <option value=""></option>
                                <?php 
    ...
    <div class="col-md-4  input-group mb-4">
        ...
        <select class="form-control" name="salada-ter-01">
                                <option value=""></option>
                                <?php 
...
<div class="form-row">
    ...
    <div class="col-md-4  input-group mb-4">
        ...
        <select class="form-control" name="prato-ter-02">
                                <option value=""></option>
                                <?php 
                                 $pratos = listarPratos($conexao);
                                   foreach($pratos as $pratos): ?>
    ...
    <div class="col-md-4  input-group mb-4">
        ...
        <select class="form-control" name="carne-ter-02">
                                <option value=""></option>
                                <?php 
                                 $carnes  = listarCarnes($conexao);
                                   foreach($carnes as $carnes ): ?>
    ...
    <div class="col-md-4  input-group mb-4">
        ...
        <select class="form-control" name="salada-ter-02">
                                <option value=""></option>
                                <?php 
                                 $saladas= listarSaladas($conexao);
                                   foreach($saladas as $saladas ): ?>
...
<div class="form-row">
    ...
    <div class="col-md-4  input-group mb-4">
        ...
        <select class="form-control" name="prato-ter-03">
                                <option value=""></option>
                                <?php 
                                 $pratos = listarPratos($conexao);
                                   foreach($pratos as $pratos): ?>
...
<div class="form-row">
    ...
    <div class="col-md-4  input-group mb-4">
        ...
        <select class="form-control" name="prato-ter-04">
                                <option value=""></option>
                                <?php 
                                 $pratos = listarPratos($conexao);
                                   foreach($pratos as $pratos): ?>
...
<div class="form-row">
    ...
    <div class="col-md-4  input-group mb-4">
        ...
        <select class="form-control" name="prato-ter-05">
                                <option value=""></option>
                                <?php 
                                 $pratos = listarPratos($conexao);
                                   foreach($pratos as $pratos): ?>
